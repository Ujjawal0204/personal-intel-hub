...
Multi-agent AI system with Task Agent + Schedule Agent.
"""
import logging
...
app = FastAPI(
    ...
    description="Multi-agent AI task and schedule management system powered by Google ADK, Gemini, and A2A protocol.",
    version="2.0.0",
)
app.add_middleware(
    CORSMiddleware,
...
async def root():
    ...
    return {
        "message": "Personal Intelligence Hub API",
        "agents": ["coordinator", "task_agent", "schedule_agent"],
        "docs": "/docs",
    }
